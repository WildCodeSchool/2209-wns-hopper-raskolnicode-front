    ...
    <main className={styles.homeMain}>
      <div className={styles.bodyPrivacy}>
        ...
        <p>
          ...
          données de <strong>Starblog</strong> sont stockées sur des serveurs en
          dans des satellites français et relèvent du droit français et a
          fortiori du droit européen. A cet égard les fichiers
          <strong>Starblog</strong> feront l&#x27;objet d&#x27;une déclaration
        ...
        <h2>
          <strong>Les informations que nous recueillons</strong>
        </h2>
        <p>
        ...
        <p>
          ...
          informations sont obligatoires. A défaut, <strong>Starblog</strong> ne
        ...
        <h2>
          <strong>Les données que nous recueillons automatiquement</strong>
        </h2>
        <p>
        ...
        <h2>
          <strong>Les destinataires de vos données</strong>
        </h2>
        <p>
          Les données collectées sur nos Services et applications sont
          exclusivement destinées à <strong>Starblog</strong>.
        </p>
        <h2>
        ...
        <p>
          ...
          suivante : <strong>Starblog</strong> - A l&#x27;attention du Délégué à
